...
const AboutMeSections: AboutMeSectionInterface[] = [
    {
        title: "Who am I",
        content: <p>I'm a 21 year old from Ireland. I have many interests, ranging from sport to <Link href="/bookshelf" className={"font-medium underline"}>reading</Link> and technology.</p>
    },
    {
        ...
        content: <>
            <p className="mb-[30px]">
                ...
                One of those things was making small ecommerce websites on <Link href="http://www.shopify.com/" target="_blank" className={"font-medium underline"}>Shopify</Link>. I had big plans
            ...
            <p className="mb-[30px]">
                ...
                to spend time learning web development frameworks like <Link href={"https://react.dev/"} target="_blank" className={"font-medium underline"}>React</Link>, as well as CI/CD processes using
                &nbsp;<Link href="https://github.com/features/actions" target="_blank" className={"font-medium underline"}>GitHub Actions</Link>.
            </p>
            <p className="mb-[30px]">
                While I was finding these technologies very very interesting (and fun), I also started to <Link href="/bookshelf" className={"font-medium underline"}>read books</Link> about copywriting for sales so that I could convert more customers
                ...
                This led me to wider topics around photorealistic product rendering via tools such as <Link href={"https://www.adobe.com/"} target="_blank" className={"font-medium underline"}>Adobe Creative Suite</Link>
                &nbsp;and <Link href="https://www.blender.org/" target="_blank" className={"font-medium underline"}>Blender</Link>.
            </p>
            <p>
                ...
                avenue for me to exercise my creativity and technical skills using <Link href={"https://www.adobe.com/"} target="_blank" className={"font-medium underline"}>Adobe Creative Suite</Link> etc.
                Check out some of my videos on the <Link href="/content-creation" className={"font-medium underline"}>Content Creation Projects Page</Link>.
            </p>
        </>,
    }
]
