...
export default function Experience() {
    return (
        <>
            <h2>Software Technician - Midland Steel Reinforcement Supplies</h2>
            <p>

            </p>

            <div className="medium-separator container">
                <p className={"side-note"} style={{fontWeight: 300}}>
                ...
                <p className={"small-separator side-note p-bold"}> - Anupam Tamrakar - Manager of Research and Development at Midland Steel</p>
            </div>
        </>
    )
}
